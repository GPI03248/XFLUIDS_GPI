    ...
    for (int kk = 0; kk < AreaI_Knum; kk++)
    {
        for (int jj = 0; jj < AreaI_Jnum; jj++)
        {
            for (int ii = 0; ii < AreaI_Inum; ii++)
            {
                ...
                fArea_I[vector_num * id_ori + 3] = sycl::sqrt(fArea_I[vector_num * id_ori + 0] * fArea_I[vector_num * id_ori + 0] + fArea_I[vector_num * id_ori + 1] * fArea_I[vector_num * id_ori + 1] + fArea_I[vector_num * id_ori + 2] * fArea_I[vector_num * id_ori + 2]);
                // ----------------------------------sqrt test pass-------------------------------------
    ...
    for (int kk = 0; kk < AreaJ_Knum; kk++)
    {
        for (int jj = 0; jj < AreaJ_Jnum; jj++)
        {
            for (int ii = 0; ii < AreaJ_Inum; ii++)
            {
                ...
                fArea_J[vector_num * id_ori + 3] = sycl::sqrt(fArea_J[vector_num * id_ori + 0] * fArea_J[vector_num * id_ori + 0] + fArea_J[vector_num * id_ori + 1] * fArea_J[vector_num * id_ori + 1] + fArea_J[vector_num * id_ori + 2] * fArea_J[vector_num * id_ori + 2]);
    ...
    for (int kk = 0; kk < AreaK_Knum; kk++)
    {
        for (int jj = 0; jj < AreaK_Jnum; jj++)
        {
            for (int ii = 0; ii < AreaK_Inum; ii++)
            {
                ...
                fArea_K[vector_num * id_ori + 3] = sycl::sqrt(fArea_K[vector_num * id_ori + 0] * fArea_K[vector_num * id_ori + 0] + fArea_K[vector_num * id_ori + 1] * fArea_K[vector_num * id_ori + 1] + fArea_K[vector_num * id_ori + 2] * fArea_K[vector_num * id_ori + 2]);
